# Extract dates and years from the text {-}
...
| 3 | `B` `Y` | `septiembre 2019`, `sep 2019` |  |
| 4 | (`B` or `b`) `d`(sign) `Y` | `julio 19 2019`, `jul 9, 2019`, `jul 9. 2019` |
| 5 | `d` de `B` `Y` | `28 de marzo 2019` |
| 6 | `d` de `B` de `Y` | `16 de octubre de 2019` |
| 7 | `d` de `B` del `Y` | `1 de octubre del 2019` | 
