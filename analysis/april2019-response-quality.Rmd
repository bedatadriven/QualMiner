...
response has a description field or not. the responses with the longest word
...
Having a description field or not is calculated as that a description field has
minimum one word. We look below the description word count, and compare with the
...
We apply linear and LOESS regressions to look at the relations.
```{r}
p1 <- dsp %>% 
