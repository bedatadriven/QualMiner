...
You can peek at the raw data below if you are interested in the data used in the
analysis.
```{r}
form.table
```
...
As we have seen previously, Not all Reporting Partners (and Implementing
Partners) record multi-line narrative textual data. 
For instance, the partner
**PMA** has lots of Implementing Partners reporting for the different data types but
there are no narratives from them.
