...
```{r child = 'analysis/data-nature.Rmd', eval=T}
```
...
```{r child = 'analysis/response-quality-word-count.Rmd', eval=T}
```

```{r child = 'analysis/response-quality-sentence-length.Rmd', eval=F}
```
